...
Fixpoint val_rel (τ : type) (v : expr) : Prop :=
  ...
  | TFun τ1 τ2 => is_val v ∧ ∀ w, val_rel τ1 w → Normalizes (val_rel τ2) (App v w)
  end.
...
Definition expr_rel (τ : type) (e : expr) := Normalizes (val_rel τ) e.
...
Proof.
  ...
  - eapply (Normalizes_bind _ _ _ (λ e, Pair e _));
    ...
    intros v1 Hv11 Hv12.
    eapply (Normalizes_bind _ _ _ (λ e, Pair _ e)); [|apply IHHtp2; trivial; fail|].
  ...
  - eapply (Normalizes_bind _ _ _ (λ e, Fst e));
    ...
    inversion Hv1; subst.
    eapply Normalizes_head_step_back; [constructor; auto; fail|].
  ...
  - eapply (Normalizes_bind _ _ _ (λ e, App e _));
      [repeat econstructor; fail|apply IHHtp1; trivial; fail|].
    intros v1 Hv11 Hv12.
    eapply (Normalizes_bind _ _ _ (λ e, App _ e)); [|apply IHHtp2; trivial; fail|].
    { repeat econstructor; trivial. }
    intros v2 Hv21 Hv22.
    apply Hv12; trivial.
Qed.
