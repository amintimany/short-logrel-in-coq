...
Proof.
  ...
  - split; intros [? Happ];
      split; [assumption|intros; eapply Safe_mono; [intros|eapply Happ]|
               assumption|intros; eapply Safe_mono; [intros|eapply Happ]];
      match goal with H : _ |- _ => apply H; eauto | H : _ |- _ => apply <- H; eauto end.
  - split; intros [? Htapp].
    + split; [assumption|].
      intros ?. eapply Safe_mono; [|eapply Htapp; fail].
      intros ? ?.
      apply (IHτ (_ :: _)); eassumption.
    + split; [assumption|].
      intros ?.
      eapply Safe_mono; [|eapply Htapp; fail].
      intros w Hw.
...
Proof.
  ...
  - eapply (Safe_bind _ _ _ (λ e, Pair e _));
    ...
    intros v1 Hv11 Hv12.
    eapply (Safe_bind _ _ _ (λ e, Pair _ e)); [|apply IHHtp2; eassumption; fail|].
  ...
  - eapply (Safe_bind _ _ _ (λ e, App e _));
      [repeat econstructor; fail|apply IHHtp1; eassumption; fail|].
    intros v1 Hv11 Hv12.
    eapply (Safe_bind _ _ _ (λ e, App _ e)); [|apply IHHtp2; eassumption; fail|].
    { repeat econstructor; trivial. }
    intros v2 Hv21 Hv22.
    apply Hv12; trivial.
  - apply Safe_val; [constructor; fail|].
  ...
  - eapply (Safe_bind _ _ _ (λ e, TApp e));
      [repeat econstructor; fail|apply IHHtp; eassumption; fail|].
    intros v ? [? Hv].
    eapply Safe_mono; [|apply Hv; fail].
